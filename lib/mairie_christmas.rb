...
def get_townhall_email(townhall_url)
  ...
  # renvoie nil sinon
  townhall_email = nil
  page = get_page(townhall_url) # Ouvre et parse la page HTML dont on donne l'URL et la stocke dans l'objet page
...
def get_townhall_urls(department_url)
  ...
  page = get_page(department_url) # Ouvre et parse la page HTML dont on donne l'URL et la stocke dans l'objet page
  if !page.nil? && page.instance_of?(Nokogiri::HTML::Document)
    title = page.xpath('/html/head/title').text
